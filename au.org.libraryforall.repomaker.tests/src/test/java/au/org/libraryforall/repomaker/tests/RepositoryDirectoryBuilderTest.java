...
public final class RepositoryDirectoryBuilderTest
{
    ...
    throws Exception
  {
    ...
    Files.copy(
      RepositoryDirectoryBuilderTest.class.getResourceAsStream(
        "/au/org/libraryforall/repomaker/tests/lfa-1.3.7-178-release.apk"),
      directory.resolve("1.apk"));
    Files.copy(
      RepositoryDirectoryBuilderTest.class.getResourceAsStream(
        "/au/org/libraryforall/repomaker/tests/lfa-1.3.7-180-release.apk"),
      directory.resolve("2.apk"));
    Files.copy(
      RepositoryDirectoryBuilderTest.class.getResourceAsStream(
        "/au/org/libraryforall/repomaker/tests/lfa-1.3.7-181-release.apk"),
      directory.resolve("3.apk"));
    Files.copy(
      RepositoryDirectoryBuilderTest.class.getResourceAsStream(
        "/au/org/libraryforall/repomaker/tests/lfa-1.3.7-231-release.apk"),
