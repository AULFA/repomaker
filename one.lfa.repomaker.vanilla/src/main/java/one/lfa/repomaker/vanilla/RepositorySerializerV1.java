...
public final class RepositorySerializerV1 implements RepositorySerializerType
{
    ...
    final Repository repository)
  {
    ...
    for (final var pack : repository.items()) {
      if (pack instanceof RepositoryAndroidPackage) {
        root.appendChild(ofPackage(document, (RepositoryAndroidPackage) pack));
      }
    }
    return root;
  }
